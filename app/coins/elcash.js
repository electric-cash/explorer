const Decimal8 = require("decimal.js").clone({precision: 8, rounding: 8});
const apiUrl = require('../consts/apiUrl');
...
module.exports = {
    ...
    nodeTitle: "ElectricCash Full Node",
    nodeUrl: "https://bitcoin.org/en/full-node",
    demoSiteUrl: "https://explorer.electriccash.global",
    ...
    currencyUnitsByName: {
        "ELCASH": currencyUnits[0],
        "mELCASH": currencyUnits[1],
